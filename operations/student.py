...
def get_student(**kwargs):
    if "db" in kwargs:
        ...
        if "class_room_id" in kwargs:
            ...
            list_of_students = db.query(Students).filter(Students.class_room == class_room_id).all()
            if list_of_students:
                return list_of_students
            else:
        ...
        if "student_roll_number" in kwargs:
            ...
            list_of_students = db.query(Students).filter(Students.roll_number == student_roll_number).first()
            if list_of_students:
                return list_of_students
            else:
